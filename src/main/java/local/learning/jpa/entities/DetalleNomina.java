...
public class DetalleNomina implements Serializable{
    ...
    public DetalleNomina(Integer Id, Integer diasLaborados, double sueldoDevengado, double auxilioTransporte, double valorHorasExtras, double descuentoSalud, double descuentoPension, double descuentoFondoSolidaridad, double otrosDescuentos, double totalDevengado, double totalDescuento, double netoPagar) {
        this.Id = Id;
